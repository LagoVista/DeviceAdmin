...
namespace LagoVista.IoT.DeviceAdmin.Models
{
    ...
    public class Sensor : KeyOwnedDeviceAdminBase, IValidateable
    {
        ...
        [FormField(LabelResource: Resources.DeviceLibraryResources.Names.Sensor_Type, HelpResource: Resources.DeviceLibraryResources.Names.Sensor_Type_Help, FieldType:FieldTypes.Picker, IsRequired: true)]
